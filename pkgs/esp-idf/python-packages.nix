...
{ fetchPypi, fetchurl, pythonPackages, }:
with pythonPackages; rec {
  idf-component-manager = buildPythonPackage rec {
    ...
    meta = { homepage = "https://github.com/espressif/idf-component-manager"; };
  };
  ...
  esp-coredump = buildPythonPackage rec {
    ...
    propagatedBuildInputs = [ construct pygdbmi esptool ];

    meta = { homepage = "https://github.com/espressif/esp-coredump"; };
  };
  ...
  esptool = buildPythonPackage rec {
    ...
    meta = { homepage = "https://github.com/espressif/esptool"; };
  };
  ...
  esp-idf-kconfig = buildPythonPackage rec {
    ...
    meta = { homepage = "https://github.com/espressif/esp-idf-kconfig"; };
  };
  ...
  esp-idf-monitor = buildPythonPackage rec {
    ...
    propagatedBuildInputs =
      [ pyserial esp-coredump pyelftools esp-idf-panic-decoder ];

    meta = { homepage = "https://github.com/espressif/esp-idf-monitor"; };
  };
  ...
  esp-idf-size = buildPythonPackage rec {
    ...
    propagatedBuildInputs = [ rich pyyaml ];

    meta = { homepage = "https://github.com/espressif/esp-idf-size"; };
  };
  ...
  pyclang = buildPythonPackage rec {
    ...
    meta = { homepage = "https://pypi.org/project/pyclang/"; };
  };
  ...
  freertos_gdb = buildPythonPackage rec {
    ...
    meta = { homepage = "https://github.com/espressif/freertos-gdb"; };
  };
  ...
  esp-idf-panic-decoder = buildPythonPackage rec {
    ...
    meta = { homepage = "https://github.com/espressif/esp-idf-panic-decoder"; };
  };
  ...
  esp-idf-diag = buildPythonPackage {
    ...
    src = fetchurl {
      url =
        "https://github.com/espressif/esp-idf-diag/archive/refs/tags/v0.2.0.tar.gz";
    ...
    propagatedBuildInputs = [ pyyaml click rich ];
